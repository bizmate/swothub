	...
	)
{
	...
	$xdebug_ini_file_path = $ini_file_path ? {
		''      => '/etc/php5/apache2/conf.d/xdebug_config.ini',
	...
	$xdebug_max_nesting_level = $max_nesting_level ? {
    ''      => '250',
    default => $max_nesting_level,
  }
  ...
  file { '/etc/php5/cli/conf.d/xdebug_config.ini':
    ensure => 'link',
    target => "$xdebug_ini_file_path",
  }
